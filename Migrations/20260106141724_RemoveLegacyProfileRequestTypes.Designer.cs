...
namespace EmployeeApi.Migrations
{
    ...
    [Migration("20260106141724_RemoveLegacyProfileRequestTypes")]
    partial class RemoveLegacyProfileRequestTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeApi.Models.EmploymentType", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("employment_type_id");
                    ...
                    b.ToTable("employment_type", "dotnet");
                });

            modelBuilder.Entity("EmployeeApi.Models.JobLevel", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("job_level_id");
                    ...
                    b.ToTable("job_level", "dotnet");
                });

            modelBuilder.Entity("EmployeeApi.Models.LeaveBalance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("leave_balance", "dotnet");
                });
            ...
            modelBuilder.Entity("EmployeeApi.Models.TimeType", b =>
                {
                    ...
                    b.Property<string>("Name")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("time_type_name");

                    b.HasKey("Id");

                    b.ToTable("time_type", "dotnet");
                });
            ...
            modelBuilder.Entity("EmployeeApi.Models.Employee", b =>
                {
                    ...
                    b.HasOne("EmployeeApi.Models.EmploymentType", "EmploymentType")
                        .WithMany()
                        .HasForeignKey("EmploymentTypeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("EmployeeApi.Models.Employee", "Hr")
                        .WithMany()
                        .HasForeignKey("HrId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("EmployeeApi.Models.JobLevel", "JobLevel")
                        .WithMany()
                    ...
                    b.HasOne("EmployeeApi.Models.TimeType", "TimeType")
                        .WithMany()
